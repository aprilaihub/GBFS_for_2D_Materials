...
class recursive_feature_elimination():
    ...
    def perform(self, cv_fold=10):
        ...
        joblib.dump(self.selector.cv_results_, os.path.join(self.path_to_save, r'RFECV_features_grid_scores_' + self.target + '.pkl'))
    ...
    def RFE_plot(self):
        ...
        plt.plot(
                self.selector.cv_results_['n_features'],    
