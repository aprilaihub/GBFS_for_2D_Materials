...
class GBFS():
    ...
    args: 
        ...
        (5) oversampled_it (type:bool) - whether to oversample the training data; choose False if already oversampled
    ...
    def oversample(self, df, technique, *args, **kwargs):
        ...
        if technique == 'ros':
            ...
            os = SMOTENC(categorical_features=self.categorical_features, k_neighbors=5)
            ...
            for fold in range(cv_folds):
                ...
                if self.problem == 'classification':
                    if self.oversampled_it == True:
                        ...
                        # Fit to model THIS WAS EDITED TO PREVENT DATAFRAME SIZE ERRORS
    ...
    def run(self, boosting_method, cv_folds, oversample_technique='smoothed_ros', *args, **kwargs):
        ...
        methods = [
                    ...
                    'hyperparameters': {
                                        'n_estimators':[100, 500, 1000], # [100, 300, 500] [100,300,500,1000]
                                        'learning_rate':[0.02, 0.05, 0.1], # [0.05,0.1,0.2]
                                        'num_leaves':[30,50] # [30,40,50] [30,40,50,70]
                                        }
                    },
    ...
    def convergence_plot(self, *args, **kwargs):
        ...
        plt.savefig(os.path.join(self.path_to_save, r'GBFS_convergence_plot_' + str(self.target) + '_' + str(validation_metric) + '.png'), dpi = 300)
        plt.show()
        print('Result saved as: GBFS_convergence_plot_' + str(self.target) + '_' + str(validation_metric) + '.png')